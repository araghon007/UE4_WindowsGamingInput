...
template<typename Base, FactoryCacheFlags cacheFlagValue = FactoryCacheDefault>
class SimpleSealedActivationFactory final : public SimpleActivationFactory<Base, cacheFlagValue>
{
};
...
template<typename Base, FactoryCacheFlags cacheFlagValue = FactoryCacheDefault>
class SimpleSealedAgileActivationFactory final : public SimpleAgileActivationFactory<Base, cacheFlagValue>
{
};
